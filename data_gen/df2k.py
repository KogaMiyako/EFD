...
if __name__ == '__main__':
    ...
    train_img_list = []
    # train_img_list += sorted(glob.glob('data/Flickr2K/Flickr2K_HR/*.png'))
    # train_img_list += sorted(glob.glob('data/DIV2K_train_HR/*.png'))
    # test_img_list = sorted(glob.glob('data/test_data/HR/manga109/*.png'))
    test_img_list = sorted(glob.glob('data/garbage/*.jpg'))
    # test_img_list = sorted(glob.glob('data/lsun_test_100/*.png'))
